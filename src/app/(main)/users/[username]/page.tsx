...
async function UserProfile({ loggedInUser, user }: UserProfileProps) {
  const follwerInfo: FollowerInfo = {
    followers: user._count.followers,
    isFollowedByUser: user.followers.some(
      (follower) => follower.followerId === loggedInUser,
    ),
  };
      ...
      <div className="flex flex-wrap gap-3 sm:flex-nowrap">
        <div className="me-auto space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <FollowerCount userId={user.id} initialData={follwerInfo} />
          </div>
        </div>
